  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route path="/react-routing-3.2/" element={<Root />}>
        ...
        <Route path="/react-routing-3.2/api" element={<CallApi />} />
        <Route
        ...
        <Route path="/react-routing-3.2/component" element={<Component />} />
        <Route path="/react-routing-3.2/user/:username" element={<User />} />
